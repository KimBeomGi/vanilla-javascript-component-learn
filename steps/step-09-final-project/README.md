...
1. 1️⃣ **`solution/index.html` 먼저 관찰하기**: 완성된 정답 캡스톤 쇼핑몰 앱을 라이브 서버로 구동하여 카테고리 필터, 장바구니 수량 조절, 라우팅, LocalStorage 동기화 동작을 감상하세요!
2. 2️⃣ **`exercise/index.html` 연동하기**: 지금까지 배운 지식을 총동원해 나만의 커머스 SPA를 주석 해제하여 완성해 보세요!
...
- [ ] 완주를 축하합니다! 이제 여러분은 자신만의 바닐라 JS 프레임워크를 만들 줄 아는 진정한 프런트엔드 개발자입니다! 🎉
